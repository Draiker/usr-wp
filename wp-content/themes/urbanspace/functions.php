...
add_filter( 'the_category_rss', 'is_premium_in_feed' );
function is_premium_in_feed( $content ) {	
    $post_categories = wp_get_post_categories( get_the_ID() );
		$premium_category_id = 4;
    if (in_array($premium_category_id, $post_categories)) {
        return $content."<isPremium>true</isPremium>";
    }
    else
        return $content."<isPremium>false</isPremium>"; 
} 
