<div class="postbox" id="last-three-months-container">
	...
	<div class="inside">
		<table class='form-table striped'>
			<thead>
			<tr>
				<th style="text-align: left; width: 5%;" class="<?php echo $sort_order['date'][0]; ?>">
					<a href="<?php echo $sort_order['date'][1] ?>">
						<span><?php echo __( 'Publish Date', 'seriously-simple-stats' ); ?></span>
						<span class="sorting-indicator"></span>
					</a>
				</th>
				<th style="text-align: left; width: 50%;" class="<?php echo $sort_order['episode_name'][0]; ?>">
				...
				<?php foreach ( $this->dates as $date ) { ?>
					<th style="text-align: center; width: 5%;" class="<?php echo $sort_order[ $date ][0]; ?>">
				...
				<?php } ?>
				<th style="text-align: center; width: 5%;" class="ssp_stats_3m_total <?php echo $sort_order['listens'][0]; ?>">
