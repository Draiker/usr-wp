...
function wpcast_blocks_authors_small_block_init() {
	...
	wp_register_style( 'wpcast-blocks-authors-small', plugins_url( $style_css, __FILE__ ), array(), filemtime( "$dir/$style_css" )    );
...
// Shortcode wrapper
function wpcast_blocks_authors_small_callback( $attributes, $content ){
